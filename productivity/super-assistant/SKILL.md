...
| Skill | 主要作用 | 适用场景与产物 |
|------|----------|----------------|
| [editing-master · 影音剪辑](skills/editing-operation-center/SKILL.md) | 创建和编辑本地剪映/CapCut 草稿，组织视频、音频、图片、文字和 SRT 字幕，设置裁剪、变速、转场、特效、贴纸及关键帧；支持素材时长分析和可用资源查询。 | 视频片段编排、配乐、图文视频、字幕制作与效果调整；主要产物是可导入剪映/CapCut 继续编辑的草稿项目。 |
